#!/usr/bin/env python3
"""
autograder.py, cs108 a02: Hello, graded in Python

The grading bundle's entry point, in Python. `cs108 marks` runs it once
...
EXPECTED_VISIBLE = 4   # checks the visible suite runs
