#!/usr/bin/env node
/*
 * autograder.js, cs108 a01: Hello, graded in JavaScript
 *
 * The grading bundle's entry point, in JavaScript. `cs108 marks` runs it
...
const EXPECTED_VISIBLE = 4;   // checks the visible suite runs
